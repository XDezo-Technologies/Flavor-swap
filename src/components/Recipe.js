    ...
    <div>
      ...
      <div class="p-6 lg:max-w-7xl max-w-2xl max-lg:mx-auto">
        <div class="grid items-start grid-cols-1 lg:grid-cols-5 gap-12">
          <div class="lg:col-span-3 bg-gray-100 rounded-sm w-full lg:sticky top-0 text-center p-8">
            <img src="https://readymadeui.com/images/coffee1.webp" alt="Product" class="w-9/12 rounded object-cover mx-auto" />

            <hr class="border-white border-2 my-6" />

            <div class="flex flex-wrap gap-x-12 gap-y-6 justify-center mx-auto">
              <img src="https://readymadeui.com/images/coffee6.webp" alt="Product1" class="w-20 cursor-pointer" />
              <img src="https://readymadeui.com/images/coffee3.webp" alt="Product2" class="w-20 cursor-pointer" />
              <img src="https://readymadeui.com/images/coffee4.webp" alt="Product3" class="w-20 cursor-pointer" />
              <img src="https://readymadeui.com/images/coffee5.webp" alt="Product4" class="w-20 cursor-pointer" />
            </div>
          </div>
          ...
          <div class="lg:col-span-2">
            ...
            <div class="flex flex-wrap gap-4 mt-4">
              <p class="text-gray-800 text-xl font-bold">Time : </p>
            </div>
            ...
            <div class="mt-8 max-w-md">
              ...
              <button type="button" class="w-full mt-8 px-4 py-2 bg-transparent border-2 border-gray-800 text-gray-800 font-bold rounded-sm">Read all reviews</button>
            </div>
          </div>
        </div>
      </div>
